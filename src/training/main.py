...
PATH_COVS = PATH_DATA+"filtered_covariances_64/" #covariances
...
conf = {'epochs': 50, 'lr': 1e-3, 'batch_size': 10, 'bire_blocks':1}
...
for i in range(5):
    ...
    model = ASPDNet(s_batch[-1],conf['bire_blocks']).to(device)
    # break
